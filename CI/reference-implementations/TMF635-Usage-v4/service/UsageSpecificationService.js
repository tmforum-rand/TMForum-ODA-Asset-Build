...
exports.createUsageSpecification = function(req, res, next) {
   ...
   *
   * usageSpecification UsageSpecification_Create The UsageSpecification to be created
   * returns UsageSpecification
   **/

  console.log('createUsageSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument usageSpecification */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createUsageSpecification: error=" + error);
    ...
    .catch( error => {
      console.log("createUsageSpecification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteUsageSpecification = function(req, res, next) {
  ...
  console.log('deleteUsageSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listUsageSpecification = function(req, res, next) {
  ...
  console.log('listUsageSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listUsageSpecification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchUsageSpecification = function(req, res, next) {
   ...
   *
   * id String Identifier of the UsageSpecification
   * usageSpecification UsageSpecification_Update The UsageSpecification to be updated
   * returns UsageSpecification
   **/

  console.log('patchUsageSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchUsageSpecification error=" + error);
...
exports.retrieveUsageSpecification = function(req, res, next) {
  ...
  console.log('retrieveUsageSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveUsageSpecification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
