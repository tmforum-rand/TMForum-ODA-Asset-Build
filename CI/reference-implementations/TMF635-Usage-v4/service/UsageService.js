...
exports.createUsage = function(req, res, next) {
   ...
   *
   * usage Usage_Create The Usage to be created
   * returns Usage
   **/

  console.log('createUsage :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument usage */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createUsage: error=" + error);
    ...
    .catch( error => {
      console.log("createUsage: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteUsage = function(req, res, next) {
  ...
  console.log('deleteUsage :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listUsage = function(req, res, next) {
  ...
  console.log('listUsage :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listUsage: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchUsage = function(req, res, next) {
   ...
   *
   * id String Identifier of the Usage
   * usage Usage_Update The Usage to be updated
   * returns Usage
   **/

  console.log('patchUsage :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchUsage error=" + error);
...
exports.retrieveUsage = function(req, res, next) {
  ...
  console.log('retrieveUsage :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveUsage: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
