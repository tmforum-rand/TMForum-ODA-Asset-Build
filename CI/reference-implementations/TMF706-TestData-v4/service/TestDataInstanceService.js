...
exports.createTestDataInstance = function(req, res, next) {
  /**
   * Creates a TestDataInstance
   * This operation creates a TestDataInstance entity.
   *
   * testDataInstance TestDataInstance_Create The TestDataInstance to be created
   * returns TestDataInstance
   **/

  console.log('createTestDataInstance :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument testDataInstance */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createTestDataInstance', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createTestDataInstance', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createTestDataInstance: error=" + error);
    ...
    .catch( error => {
      console.log("createTestDataInstance: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteTestDataInstance = function(req, res, next) {
  /**
  ...
  console.log('deleteTestDataInstance :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listTestDataInstance = function(req, res, next) {
  /**
  ...
  console.log('listTestDataInstance :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listTestDataInstance: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchTestDataInstance = function(req, res, next) {
  /**
   * Updates partially a TestDataInstance
   * This operation updates partially a TestDataInstance entity.
   *
   * id String Identifier of the TestDataInstance
   * testDataInstance TestDataInstance_Update The TestDataInstance to be updated
   * returns TestDataInstance
   **/

  console.log('patchTestDataInstance :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchTestDataInstance',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchTestDataInstance error=" + error);
...
exports.retrieveTestDataInstance = function(req, res, next) {
  /**
  ...
  console.log('retrieveTestDataInstance :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveTestDataInstance: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
