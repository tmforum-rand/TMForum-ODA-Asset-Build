...
exports.createResourceOrder = function(req, res, next) {
   ...
   *
   * resourceOrder ResourceOrder_Create The ResourceOrder to be created
   * returns ResourceOrder
   **/

  console.log('createResourceOrder :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument resourceOrder */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createResourceOrder: error=" + error);
    ...
    .catch( error => {
      console.log("createResourceOrder: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteResourceOrder = function(req, res, next) {
  ...
  console.log('deleteResourceOrder :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listResourceOrder = function(req, res, next) {
  ...
  console.log('listResourceOrder :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listResourceOrder: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchResourceOrder = function(req, res, next) {
   ...
   *
   * id String Identifier of the ResourceOrder
   * resourceOrder ResourceOrder_Update The ResourceOrder to be updated
   * returns ResourceOrder
   **/

  console.log('patchResourceOrder :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchResourceOrder error=" + error);
...
exports.retrieveResourceOrder = function(req, res, next) {
  ...
  console.log('retrieveResourceOrder :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveResourceOrder: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
