...
exports.createTestScenario = function(req, res, next) {
  /**
   * Creates a TestScenario
   * This operation creates a TestScenario entity.
   *
   * testScenario TestScenario_Create The TestScenario to be created
   * returns TestScenario
   **/

  console.log('createTestScenario :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument testScenario */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createTestScenario', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createTestScenario', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createTestScenario: error=" + error);
    ...
    .catch( error => {
      console.log("createTestScenario: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteTestScenario = function(req, res, next) {
  /**
  ...
  console.log('deleteTestScenario :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listTestScenario = function(req, res, next) {
  /**
  ...
  console.log('listTestScenario :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listTestScenario: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchTestScenario = function(req, res, next) {
  /**
   * Updates partially a TestScenario
   * This operation updates partially a TestScenario entity.
   *
   * id String Identifier of the TestScenario
   * testScenario TestScenario_Update The TestScenario to be updated
   * returns TestScenario
   **/

  console.log('patchTestScenario :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchTestScenario',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchTestScenario error=" + error);
...
exports.retrieveTestScenario = function(req, res, next) {
  /**
  ...
  console.log('retrieveTestScenario :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveTestScenario: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
