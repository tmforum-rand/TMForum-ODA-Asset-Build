...
exports.createEntityCatalogItem = function(req, res, next) {
  /**
   * Creates a EntityCatalogItem
   * This operation creates a EntityCatalogItem entity.
   *
   * entityCatalogItem EntityCatalogItem_Create The EntityCatalogItem to be created
   * returns EntityCatalogItem
   **/

  console.log('createEntityCatalogItem :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument entityCatalogItem */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createEntityCatalogItem', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createEntityCatalogItem', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createEntityCatalogItem: error=" + error);
    ...
    .catch( error => {
      console.log("createEntityCatalogItem: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteEntityCatalogItem = function(req, res, next) {
  /**
  ...
  console.log('deleteEntityCatalogItem :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listEntityCatalogItem = function(req, res, next) {
  /**
  ...
  console.log('listEntityCatalogItem :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listEntityCatalogItem: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchEntityCatalogItem = function(req, res, next) {
  /**
   * Updates partially a EntityCatalogItem
   * This operation updates partially a EntityCatalogItem entity.
   *
   * id String Identifier of the EntityCatalogItem
   * entityCatalogItem EntityCatalogItem_Update The EntityCatalogItem to be updated
   * returns EntityCatalogItem
   **/

  console.log('patchEntityCatalogItem :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchEntityCatalogItem',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchEntityCatalogItem error=" + error);
...
exports.retrieveEntityCatalogItem = function(req, res, next) {
  /**
  ...
  console.log('retrieveEntityCatalogItem :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveEntityCatalogItem: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
