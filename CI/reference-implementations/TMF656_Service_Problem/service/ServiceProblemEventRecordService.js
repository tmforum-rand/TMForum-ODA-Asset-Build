...
exports.listServiceProblemEventRecord = function(req, res, next) {
  /**
  ...
  console.log('listServiceProblemEventRecord :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listServiceProblemEventRecord: error=" + error);
...
exports.retrieveServiceProblemEventRecord = function(req, res, next) {
  /**
  ...
  console.log('retrieveServiceProblemEventRecord :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveServiceProblemEventRecord: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
