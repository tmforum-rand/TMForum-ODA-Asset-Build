...
exports.createTestResourceAPI = function(req, res, next) {
  /**
   * Creates a TestResourceAPI
   * This operation creates a TestResourceAPI entity.
   *
   * testResourceAPI TestResourceAPI_Create The TestResourceAPI to be created
   * returns TestResourceAPI
   **/

  console.log('createTestResourceAPI :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument testResourceAPI */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createTestResourceAPI', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createTestResourceAPI', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createTestResourceAPI: error=" + error);
    ...
    .catch( error => {
      console.log("createTestResourceAPI: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteTestResourceAPI = function(req, res, next) {
  /**
  ...
  console.log('deleteTestResourceAPI :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listTestResourceAPI = function(req, res, next) {
  /**
  ...
  console.log('listTestResourceAPI :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listTestResourceAPI: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchTestResourceAPI = function(req, res, next) {
  /**
   * Updates partially a TestResourceAPI
   * This operation updates partially a TestResourceAPI entity.
   *
   * id String Identifier of the TestResourceAPI
   * testResourceAPI TestResourceAPI_Update The TestResourceAPI to be updated
   * returns TestResourceAPI
   **/

  console.log('patchTestResourceAPI :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchTestResourceAPI',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchTestResourceAPI error=" + error);
...
exports.retrieveTestResourceAPI = function(req, res, next) {
  /**
  ...
  console.log('retrieveTestResourceAPI :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveTestResourceAPI: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
