...
exports.createServiceCategory = function(req, res, next) {
   ...
   *
   * serviceCategory ServiceCategory_Create The ServiceCategory to be created
   * returns ServiceCategory
   **/

  console.log('createServiceCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument serviceCategory */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createServiceCategory: error=" + error);
    ...
    .catch( error => {
      console.log("createServiceCategory: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteServiceCategory = function(req, res, next) {
  ...
  console.log('deleteServiceCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listServiceCategory = function(req, res, next) {
  ...
  console.log('listServiceCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listServiceCategory: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchServiceCategory = function(req, res, next) {
   ...
   *
   * id String Identifier of the ServiceCategory
   * serviceCategory ServiceCategory_Update The ServiceCategory to be updated
   * returns ServiceCategory
   **/

  console.log('patchServiceCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchServiceCategory error=" + error);
...
exports.retrieveServiceCategory = function(req, res, next) {
  ...
  console.log('retrieveServiceCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveServiceCategory: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
