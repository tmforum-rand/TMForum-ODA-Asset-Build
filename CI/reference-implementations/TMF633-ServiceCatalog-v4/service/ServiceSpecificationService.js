...
exports.createServiceSpecification = function(req, res, next) {
   ...
   *
   * serviceSpecification ServiceSpecification_Create The ServiceSpecification to be created
   * returns ServiceSpecification
   **/

  console.log('createServiceSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument serviceSpecification */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createServiceSpecification: error=" + error);
    ...
    .catch( error => {
      console.log("createServiceSpecification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteServiceSpecification = function(req, res, next) {
  ...
  console.log('deleteServiceSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listServiceSpecification = function(req, res, next) {
  ...
  console.log('listServiceSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listServiceSpecification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchServiceSpecification = function(req, res, next) {
   ...
   *
   * id String Identifier of the ServiceSpecification
   * serviceSpecification ServiceSpecification_Update The ServiceSpecification to be updated
   * returns ServiceSpecification
   **/

  console.log('patchServiceSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchServiceSpecification error=" + error);
...
exports.retrieveServiceSpecification = function(req, res, next) {
  ...
  console.log('retrieveServiceSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveServiceSpecification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
