...
exports.createCheckServiceQualification = function(req, res, next) {
  /**
   * Creates a CheckServiceQualification
   * This operation creates a CheckServiceQualification entity.
   *
   * checkServiceQualification CheckServiceQualification_Create The CheckServiceQualification to be created
   * returns CheckServiceQualification
   **/

  console.log('createCheckServiceQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument checkServiceQualification */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createCheckServiceQualification', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createCheckServiceQualification', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createCheckServiceQualification: error=" + error);
    ...
    .catch( error => {
      console.log("createCheckServiceQualification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteCheckServiceQualification = function(req, res, next) {
  /**
  ...
  console.log('deleteCheckServiceQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listCheckServiceQualification = function(req, res, next) {
  /**
  ...
  console.log('listCheckServiceQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listCheckServiceQualification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchCheckServiceQualification = function(req, res, next) {
  /**
   * Updates partially a CheckServiceQualification
   * This operation updates partially a CheckServiceQualification entity.
   *
   * id String Identifier of the CheckServiceQualification
   * checkServiceQualification CheckServiceQualification_Update The CheckServiceQualification to be updated
   * returns CheckServiceQualification
   **/

  console.log('patchCheckServiceQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchCheckServiceQualification',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchCheckServiceQualification error=" + error);
...
exports.retrieveCheckServiceQualification = function(req, res, next) {
  /**
  ...
  console.log('retrieveCheckServiceQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveCheckServiceQualification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
