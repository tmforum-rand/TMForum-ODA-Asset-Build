...
exports.createProductOfferingQualification = function(req, res, next) {
  /**
   * Creates a ProductOfferingQualification
   * This operation creates a ProductOfferingQualification entity.
   *
   * productOfferingQualification ProductOfferingQualification_Create The ProductOfferingQualification to be created
   * returns ProductOfferingQualification
   **/

  console.log('createProductOfferingQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument productOfferingQualification */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createProductOfferingQualification', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createProductOfferingQualification', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createProductOfferingQualification: error=" + error);
    ...
    .catch( error => {
      console.log("createProductOfferingQualification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteProductOfferingQualification = function(req, res, next) {
  /**
  ...
  console.log('deleteProductOfferingQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listProductOfferingQualification = function(req, res, next) {
  /**
  ...
  console.log('listProductOfferingQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listProductOfferingQualification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchProductOfferingQualification = function(req, res, next) {
  /**
   * Updates partially a ProductOfferingQualification
   * This operation updates partially a ProductOfferingQualification entity.
   *
   * id String Identifier of the ProductOfferingQualification
   * productOfferingQualification ProductOfferingQualification_Update The ProductOfferingQualification to be updated
   * returns ProductOfferingQualification
   **/

  console.log('patchProductOfferingQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchProductOfferingQualification',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchProductOfferingQualification error=" + error);
...
exports.retrieveProductOfferingQualification = function(req, res, next) {
  /**
  ...
  console.log('retrieveProductOfferingQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveProductOfferingQualification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
