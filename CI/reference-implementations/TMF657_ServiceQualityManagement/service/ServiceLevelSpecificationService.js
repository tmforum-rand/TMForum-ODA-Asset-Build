...
exports.createServiceLevelSpecification = function(req, res, next) {
   ...
   *
   * serviceLevelSpecification ServiceLevelSpecification_Create The ServiceLevelSpecification to be created
   * returns ServiceLevelSpecification
   **/

  console.log('createServiceLevelSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument serviceLevelSpecification */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createServiceLevelSpecification: error=" + error);
    ...
    .catch( error => {
      console.log("createServiceLevelSpecification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteServiceLevelSpecification = function(req, res, next) {
  ...
  console.log('deleteServiceLevelSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listServiceLevelSpecification = function(req, res, next) {
  ...
  console.log('listServiceLevelSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listServiceLevelSpecification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchServiceLevelSpecification = function(req, res, next) {
   ...
   *
   * id String Identifier of the ServiceLevelSpecification
   * serviceLevelSpecification ServiceLevelSpecification_Update The ServiceLevelSpecification to be updated
   * returns ServiceLevelSpecification
   **/

  console.log('patchServiceLevelSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchServiceLevelSpecification error=" + error);
...
exports.retrieveServiceLevelSpecification = function(req, res, next) {
  ...
  console.log('retrieveServiceLevelSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveServiceLevelSpecification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
