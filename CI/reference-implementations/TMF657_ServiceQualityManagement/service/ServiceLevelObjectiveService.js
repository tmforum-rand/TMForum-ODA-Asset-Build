...
exports.createServiceLevelObjective = function(req, res, next) {
   ...
   *
   * serviceLevelObjective ServiceLevelObjective_Create The ServiceLevelObjective to be created
   * returns ServiceLevelObjective
   **/

  console.log('createServiceLevelObjective :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument serviceLevelObjective */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createServiceLevelObjective: error=" + error);
    ...
    .catch( error => {
      console.log("createServiceLevelObjective: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteServiceLevelObjective = function(req, res, next) {
  ...
  console.log('deleteServiceLevelObjective :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listServiceLevelObjective = function(req, res, next) {
  ...
  console.log('listServiceLevelObjective :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listServiceLevelObjective: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchServiceLevelObjective = function(req, res, next) {
   ...
   *
   * id String Identifier of the ServiceLevelObjective
   * serviceLevelObjective ServiceLevelObjective_Update The ServiceLevelObjective to be updated
   * returns ServiceLevelObjective
   **/

  console.log('patchServiceLevelObjective :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchServiceLevelObjective error=" + error);
...
exports.retrieveServiceLevelObjective = function(req, res, next) {
  ...
  console.log('retrieveServiceLevelObjective :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveServiceLevelObjective: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
