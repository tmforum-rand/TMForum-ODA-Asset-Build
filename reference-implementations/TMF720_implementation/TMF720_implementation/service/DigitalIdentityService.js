...
exports.createDigitalIdentity = function(req, res, next) {
  /**
   * Creates a DigitalIdentity
   * This operation creates a DigitalIdentity entity.
   *
   * digitalIdentity DigitalIdentity_Create The DigitalIdentity to be created
   * returns DigitalIdentity
   **/

  console.log('createDigitalIdentity :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument digitalIdentity */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createDigitalIdentity', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createDigitalIdentity', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createDigitalIdentity: error=" + error);
    ...
    .catch( error => {
      console.log("createDigitalIdentity: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteDigitalIdentity = function(req, res, next) {
  /**
  ...
  console.log('deleteDigitalIdentity :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listDigitalIdentity = function(req, res, next) {
  /**
  ...
  console.log('listDigitalIdentity :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  if (query.criteria.creationDate){
    query.criteria.creationDate = query.criteria.creationDate.toJSON()
  }
  mongoUtils.connect()
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listDigitalIdentity: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchDigitalIdentity = function(req, res, next) {
  /**
   * Updates partially a DigitalIdentity
   * This operation updates partially a DigitalIdentity entity.
   *
   * id String Identifier of the DigitalIdentity
   * digitalIdentity DigitalIdentity_Update The DigitalIdentity to be updated
   * returns DigitalIdentity
   **/

  console.log('patchDigitalIdentity :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchDigitalIdentity',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchDigitalIdentity error=" + error);
...
exports.retrieveDigitalIdentity = function(req, res, next) {
  /**
  ...
  console.log('retrieveDigitalIdentity :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveDigitalIdentity: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
