...
exports.listBalanceAction = function(req, res, next) {
  /**
   * List or find BalanceAction objects
   * This operation list or find BalanceAction entities
   *
  ...
  console.log('listBalanceAction :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listBalanceAction: error=" + error);
...
exports.retrieveBalanceAction = function(req, res, next) {
  /**
   * Retrieves a BalanceAction by ID
   * This operation retrieves a BalanceAction entity. Attribute selection is enabled for all first level attributes.
   *
   * id String Identifier of the BalanceAction
   * fields String Comma-separated properties to provide in response (optional)
   * returns BalanceAction
   **/

  console.log('retrieveBalanceAction :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveBalanceAction: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
