...
exports.listAccumulatedBalance = function(req, res, next) {
  /**
  ...
  console.log('listAccumulatedBalance :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listAccumulatedBalance: error=" + error);
...
exports.retrieveAccumulatedBalance = function(req, res, next) {
  /**
  ...
  console.log('retrieveAccumulatedBalance :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveAccumulatedBalance: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
