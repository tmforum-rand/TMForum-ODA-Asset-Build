...
exports.createPartyPrivacyProfile = function(req, res, next) {
  /**
  ...
  console.log('createPartyPrivacyProfile :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument partyPrivacyProfile */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createPartyPrivacyProfile', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createPartyPrivacyProfile', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createPartyPrivacyProfile: error=" + error);
    ...
    .catch( error => {
      console.log("createPartyPrivacyProfile: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deletePartyPrivacyProfile = function(req, res, next) {
  /**
  ...
  console.log('deletePartyPrivacyProfile :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listPartyPrivacyProfile = function(req, res, next) {
  /**
  ...
  console.log('listPartyPrivacyProfile :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listPartyPrivacyProfile: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchPartyPrivacyProfile = function(req, res, next) {
  /**
  ...
  console.log('patchPartyPrivacyProfile :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchPartyPrivacyProfile',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchPartyPrivacyProfile error=" + error);
...
exports.retrievePartyPrivacyProfile = function(req, res, next) {
  /**
  ...
  console.log('retrievePartyPrivacyProfile :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrievePartyPrivacyProfile: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
