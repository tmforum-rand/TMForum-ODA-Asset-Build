...
exports.createPartyPrivacyAgreement = function(req, res, next) {
  /**
  ...
  console.log('createPartyPrivacyAgreement :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument partyPrivacyAgreement */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createPartyPrivacyAgreement', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createPartyPrivacyAgreement', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createPartyPrivacyAgreement: error=" + error);
    ...
    .catch( error => {
      console.log("createPartyPrivacyAgreement: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deletePartyPrivacyAgreement = function(req, res, next) {
  /**
  ...
  console.log('deletePartyPrivacyAgreement :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listPartyPrivacyAgreement = function(req, res, next) {
  /**
  ...
  console.log('listPartyPrivacyAgreement :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listPartyPrivacyAgreement: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchPartyPrivacyAgreement = function(req, res, next) {
  /**
  ...
  console.log('patchPartyPrivacyAgreement :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchPartyPrivacyAgreement',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchPartyPrivacyAgreement error=" + error);
...
exports.retrievePartyPrivacyAgreement = function(req, res, next) {
  /**
  ...
  console.log('retrievePartyPrivacyAgreement :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrievePartyPrivacyAgreement: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
