...
exports.createShoppingCartRiskAssessment = function(req, res, next) {
  /**
   * Creates a ShoppingCartRiskAssessment
   * This operation creates a ShoppingCartRiskAssessment entity.
   *
   * shoppingCartRiskAssessment ShoppingCartRiskAssessment_Create The ShoppingCartRiskAssessment to be created
   * returns ShoppingCartRiskAssessment
   **/

  console.log('createShoppingCartRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument shoppingCartRiskAssessment */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createShoppingCartRiskAssessment', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createShoppingCartRiskAssessment', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createShoppingCartRiskAssessment: error=" + error);
    ...
    .catch( error => {
      console.log("createShoppingCartRiskAssessment: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteShoppingCartRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('deleteShoppingCartRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listShoppingCartRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('listShoppingCartRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listShoppingCartRiskAssessment: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveShoppingCartRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('retrieveShoppingCartRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveShoppingCartRiskAssessment: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
