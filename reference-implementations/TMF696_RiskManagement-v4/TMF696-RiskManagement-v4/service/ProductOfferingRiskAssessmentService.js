...
exports.createProductOfferingRiskAssessment = function(req, res, next) {
  /**
   * Creates a ProductOfferingRiskAssessment
   * This operation creates a ProductOfferingRiskAssessment entity.
   *
   * productOfferingRiskAssessment ProductOfferingRiskAssessment_Create The ProductOfferingRiskAssessment to be created
   * returns ProductOfferingRiskAssessment
   **/

  console.log('createProductOfferingRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument productOfferingRiskAssessment */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createProductOfferingRiskAssessment', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createProductOfferingRiskAssessment', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createProductOfferingRiskAssessment: error=" + error);
    ...
    .catch( error => {
      console.log("createProductOfferingRiskAssessment: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteProductOfferingRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('deleteProductOfferingRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listProductOfferingRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('listProductOfferingRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listProductOfferingRiskAssessment: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveProductOfferingRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('retrieveProductOfferingRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveProductOfferingRiskAssessment: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
