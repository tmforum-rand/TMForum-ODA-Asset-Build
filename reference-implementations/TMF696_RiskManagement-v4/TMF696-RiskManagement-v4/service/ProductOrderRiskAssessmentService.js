...
exports.createProductOrderRiskAssessment = function(req, res, next) {
  /**
   * Creates a ProductOrderRiskAssessment
   * This operation creates a ProductOrderRiskAssessment entity.
   *
   * productOrderRiskAssessment ProductOrderRiskAssessment_Create The ProductOrderRiskAssessment to be created
   * returns ProductOrderRiskAssessment
   **/

  console.log('createProductOrderRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument productOrderRiskAssessment */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createProductOrderRiskAssessment', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createProductOrderRiskAssessment', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createProductOrderRiskAssessment: error=" + error);
    ...
    .catch( error => {
      console.log("createProductOrderRiskAssessment: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteProductOrderRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('deleteProductOrderRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listProductOrderRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('listProductOrderRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listProductOrderRiskAssessment: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveProductOrderRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('retrieveProductOrderRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveProductOrderRiskAssessment: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
