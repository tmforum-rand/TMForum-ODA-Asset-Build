...
exports.createNonFunctionalTestModel = function(req, res, next) {
  /**
   * Creates a NonFunctionalTestModel
   * This operation creates a NonFunctionalTestModel entity.
   *
   * nonFunctionalTestModel NonFunctionalTestModel_Create The NonFunctionalTestModel to be created
   * returns NonFunctionalTestModel
   **/

  console.log('createNonFunctionalTestModel :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument nonFunctionalTestModel */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createNonFunctionalTestModel', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createNonFunctionalTestModel', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createNonFunctionalTestModel: error=" + error);
    ...
    .catch( error => {
      console.log("createNonFunctionalTestModel: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteNonFunctionalTestModel = function(req, res, next) {
  /**
  ...
  console.log('deleteNonFunctionalTestModel :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listNonFunctionalTestModel = function(req, res, next) {
  /**
  ...
  console.log('listNonFunctionalTestModel :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listNonFunctionalTestModel: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchNonFunctionalTestModel = function(req, res, next) {
  /**
   * Updates partially a NonFunctionalTestModel
   * This operation updates partially a NonFunctionalTestModel entity.
   *
   * id String Identifier of the NonFunctionalTestModel
   * nonFunctionalTestModel NonFunctionalTestModel_Update The NonFunctionalTestModel to be updated
   * returns NonFunctionalTestModel
   **/

  console.log('patchNonFunctionalTestModel :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchNonFunctionalTestModel',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchNonFunctionalTestModel error=" + error);
...
exports.retrieveNonFunctionalTestModel = function(req, res, next) {
  /**
  ...
  console.log('retrieveNonFunctionalTestModel :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveNonFunctionalTestModel: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
