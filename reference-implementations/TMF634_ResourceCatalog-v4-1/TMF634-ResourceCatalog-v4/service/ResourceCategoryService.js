...
exports.createResourceCategory = function(req, res, next) {
  /**
   * Creates a ResourceCategory
   * This operation creates a ResourceCategory entity.
   *
   * resourceCategory ResourceCategory_Create The ResourceCategory to be created
   * returns ResourceCategory
   **/

  console.log('createResourceCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument resourceCategory */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createResourceCategory', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createResourceCategory', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createResourceCategory: error=" + error);
    ...
    .catch( error => {
      console.log("createResourceCategory: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteResourceCategory = function(req, res, next) {
  /**
  ...
  console.log('deleteResourceCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listResourceCategory = function(req, res, next) {
  /**
  ...
  console.log('listResourceCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listResourceCategory: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchResourceCategory = function(req, res, next) {
  /**
   * Updates partially a ResourceCategory
   * This operation updates partially a ResourceCategory entity.
   *
   * id String Identifier of the ResourceCategory
   * resourceCategory ResourceCategory_Update The ResourceCategory to be updated
   * returns ResourceCategory
   **/

  console.log('patchResourceCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchResourceCategory',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchResourceCategory error=" + error);
...
exports.retrieveResourceCategory = function(req, res, next) {
  /**
  ...
  console.log('retrieveResourceCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveResourceCategory: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
