...
exports.listAppliedCustomerBillingRate = function(req, res, next) {
  /**
  ...
  console.log('listAppliedCustomerBillingRate :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listAppliedCustomerBillingRate: error=" + error);
...
exports.retrieveAppliedCustomerBillingRate = function(req, res, next) {
  /**
  ...
  console.log('retrieveAppliedCustomerBillingRate :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveAppliedCustomerBillingRate: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
