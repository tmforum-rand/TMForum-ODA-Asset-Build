...
exports.listBillCycle = function(req, res, next) {
  /**
   * List or find BillCycle objects
   * This operation list or find BillCycle entities
   *
  ...
  console.log('listBillCycle :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listBillCycle: error=" + error);
...
exports.retrieveBillCycle = function(req, res, next) {
  /**
   * Retrieves a BillCycle by ID
   * This operation retrieves a BillCycle entity. Attribute selection is enabled for all first level attributes.
   *
   * id String Identifier of the BillCycle
   * fields String Comma-separated properties to provide in response (optional)
   * returns BillCycle
   **/

  console.log('retrieveBillCycle :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveBillCycle: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
