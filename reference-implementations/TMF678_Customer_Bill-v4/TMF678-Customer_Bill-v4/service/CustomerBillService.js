...
exports.listCustomerBill = function(req, res, next) {
  /**
  ...
  console.log('listCustomerBill :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listCustomerBill: error=" + error);
...
exports.patchCustomerBill = function(req, res, next) {
  /**
   ...
   * customerBill CustomerBill_Update The CustomerBill to be updated
   * returns CustomerBill
   **/

  console.log('patchCustomerBill :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchCustomerBill',payload))
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchCustomerBill error=" + error);
...
exports.retrieveCustomerBill = function(req, res, next) {
  /**
  ...
  console.log('retrieveCustomerBill :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveCustomerBill: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
