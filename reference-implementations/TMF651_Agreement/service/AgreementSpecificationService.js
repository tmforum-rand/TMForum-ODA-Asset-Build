...
exports.createAgreementSpecification = function(req, res, next) {
  /**
   * Creates a AgreementSpecification
   * This operation creates a AgreementSpecification entity.
   *
   * agreementSpecification AgreementSpecification_Create The AgreementSpecification to be created
   * returns AgreementSpecification
   **/

  console.log('createAgreementSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument agreementSpecification */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createAgreementSpecification', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createAgreementSpecification', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createAgreementSpecification: error=" + error);
    ...
    .catch( error => {
      console.log("createAgreementSpecification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteAgreementSpecification = function(req, res, next) {
  /**
  ...
  console.log('deleteAgreementSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listAgreementSpecification = function(req, res, next) {
  /**
  ...
  console.log('listAgreementSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listAgreementSpecification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchAgreementSpecification = function(req, res, next) {
  /**
   * Updates partially a AgreementSpecification
   * This operation updates partially a AgreementSpecification entity.
   *
   * id String Identifier of the AgreementSpecification
   * agreementSpecification AgreementSpecification_Update The AgreementSpecification to be updated
   * returns AgreementSpecification
   **/

  console.log('patchAgreementSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchAgreementSpecification',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchAgreementSpecification error=" + error);
...
exports.retrieveAgreementSpecification = function(req, res, next) {
  /**
  ...
  console.log('retrieveAgreementSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveAgreementSpecification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
