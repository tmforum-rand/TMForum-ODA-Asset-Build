...
exports.createAgreement = function(req, res, next) {
  /**
   * Creates a Agreement
   * This operation creates a Agreement entity.
   *
   * agreement Agreement_Create The Agreement to be created
   * returns Agreement
   **/

  console.log('createAgreement :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument agreement */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createAgreement', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createAgreement', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createAgreement: error=" + error);
    ...
    .catch( error => {
      console.log("createAgreement: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteAgreement = function(req, res, next) {
  /**
   * Deletes a Agreement
  ...
  console.log('deleteAgreement :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listAgreement = function(req, res, next) {
  /**
  ...
  console.log('listAgreement :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listAgreement: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchAgreement = function(req, res, next) {
  /**
   * Updates partially a Agreement
   * This operation updates partially a Agreement entity.
   *
   * id String Identifier of the Agreement
   * agreement Agreement_Update The Agreement to be updated
   * returns Agreement
   **/

  console.log('patchAgreement :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchAgreement',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchAgreement error=" + error);
...
exports.retrieveAgreement = function(req, res, next) {
  /**
  ...
  console.log('retrieveAgreement :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveAgreement: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
