...
exports.createPartyPrivacyProfileSpecification = function(req, res, next) {
  /**
  ...
  console.log('createPartyPrivacyProfileSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument partyPrivacyProfileSpecification */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createPartyPrivacyProfileSpecification', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createPartyPrivacyProfileSpecification', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createPartyPrivacyProfileSpecification: error=" + error);
    ...
    .catch( error => {
      console.log("createPartyPrivacyProfileSpecification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deletePartyPrivacyProfileSpecification = function(req, res, next) {
  /**
  ...
  console.log('deletePartyPrivacyProfileSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listPartyPrivacyProfileSpecification = function(req, res, next) {
  /**
  ...
  console.log('listPartyPrivacyProfileSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listPartyPrivacyProfileSpecification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchPartyPrivacyProfileSpecification = function(req, res, next) {
  /**
  ...
  console.log('patchPartyPrivacyProfileSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchPartyPrivacyProfileSpecification',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchPartyPrivacyProfileSpecification error=" + error);
...
exports.retrievePartyPrivacyProfileSpecification = function(req, res, next) {
  /**
  ...
  console.log('retrievePartyPrivacyProfileSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrievePartyPrivacyProfileSpecification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
