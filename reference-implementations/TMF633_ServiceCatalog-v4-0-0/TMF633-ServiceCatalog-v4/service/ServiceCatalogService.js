...
exports.createServiceCatalog = function(req, res, next) {
   ...
   *
   * serviceCatalog ServiceCatalog_Create The ServiceCatalog to be created
   * returns ServiceCatalog
   **/

  console.log('createServiceCatalog :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument serviceCatalog */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createServiceCatalog: error=" + error);
    ...
    .catch( error => {
      console.log("createServiceCatalog: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteServiceCatalog = function(req, res, next) {
  ...
  console.log('deleteServiceCatalog :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listServiceCatalog = function(req, res, next) {
  ...
  console.log('listServiceCatalog :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listServiceCatalog: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchServiceCatalog = function(req, res, next) {
   ...
   *
   * id String Identifier of the ServiceCatalog
   * serviceCatalog ServiceCatalog_Update The ServiceCatalog to be updated
   * returns ServiceCatalog
   **/

  console.log('patchServiceCatalog :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchServiceCatalog error=" + error);
...
exports.retrieveServiceCatalog = function(req, res, next) {
  ...
  console.log('retrieveServiceCatalog :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveServiceCatalog: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
