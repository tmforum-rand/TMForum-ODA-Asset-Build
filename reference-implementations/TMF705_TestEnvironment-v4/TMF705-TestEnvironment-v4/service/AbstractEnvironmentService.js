...
exports.createAbstractEnvironment = function(req, res, next) {
  /**
   * Creates a AbstractEnvironment
   * This operation creates a AbstractEnvironment entity.
   *
   * abstractEnvironment AbstractEnvironment_Create The AbstractEnvironment to be created
   * returns AbstractEnvironment
   **/

  console.log('createAbstractEnvironment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument abstractEnvironment */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createAbstractEnvironment', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createAbstractEnvironment', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createAbstractEnvironment: error=" + error);
    ...
    .catch( error => {
      console.log("createAbstractEnvironment: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteAbstractEnvironment = function(req, res, next) {
  /**
  ...
  console.log('deleteAbstractEnvironment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listAbstractEnvironment = function(req, res, next) {
  /**
  ...
  console.log('listAbstractEnvironment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listAbstractEnvironment: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchAbstractEnvironment = function(req, res, next) {
  /**
   * Updates partially a AbstractEnvironment
   * This operation updates partially a AbstractEnvironment entity.
   *
   * id String Identifier of the AbstractEnvironment
   * abstractEnvironment AbstractEnvironment_Update The AbstractEnvironment to be updated
   * returns AbstractEnvironment
   **/

  console.log('patchAbstractEnvironment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchAbstractEnvironment',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchAbstractEnvironment error=" + error);
...
exports.retrieveAbstractEnvironment = function(req, res, next) {
  /**
  ...
  console.log('retrieveAbstractEnvironment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveAbstractEnvironment: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
