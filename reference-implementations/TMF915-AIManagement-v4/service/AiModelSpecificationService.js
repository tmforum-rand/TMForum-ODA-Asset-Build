...
exports.createAiModelSpecification = function(req, res, next) {
  /**
   * Creates a AiModelSpecification
   * This operation creates a AiModelSpecification entity.
   *
   * aiModelSpecification AiModelSpecification_Create The AiModelSpecification to be created
   * returns AiModelSpecification
   **/

  console.log('createAiModelSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument aiModelSpecification */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createAiModelSpecification', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createAiModelSpecification', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createAiModelSpecification: error=" + error);
    ...
    .catch( error => {
      console.log("createAiModelSpecification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteAiModelSpecification = function(req, res, next) {
  /**
  ...
  console.log('deleteAiModelSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listAiModelSpecification = function(req, res, next) {
  /**
  ...
  console.log('listAiModelSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listAiModelSpecification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchAiModelSpecification = function(req, res, next) {
  /**
   * Updates partially a AiModelSpecification
   * This operation updates partially a AiModelSpecification entity.
   *
   * id String Identifier of the AiModelSpecification
   * aiModelSpecification AiModelSpecification_Update The AiModelSpecification to be updated
   * returns AiModelSpecification
   **/

  console.log('patchAiModelSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchAiModelSpecification',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchAiModelSpecification error=" + error);
...
exports.retrieveAiModelSpecification = function(req, res, next) {
  /**
  ...
  console.log('retrieveAiModelSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveAiModelSpecification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
