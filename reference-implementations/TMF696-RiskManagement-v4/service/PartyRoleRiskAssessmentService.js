...
exports.createPartyRoleRiskAssessment = function(req, res, next) {
  /**
   * Creates a PartyRoleRiskAssessment
   * This operation creates a PartyRoleRiskAssessment entity.
   *
   * partyRoleRiskAssessment PartyRoleRiskAssessment_Create The PartyRoleRiskAssessment to be created
   * returns PartyRoleRiskAssessment
   **/

  console.log('createPartyRoleRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument partyRoleRiskAssessment */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createPartyRoleRiskAssessment', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createPartyRoleRiskAssessment', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createPartyRoleRiskAssessment: error=" + error);
    ...
    .catch( error => {
      console.log("createPartyRoleRiskAssessment: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deletePartyRoleRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('deletePartyRoleRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listPartyRoleRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('listPartyRoleRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listPartyRoleRiskAssessment: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrievePartyRoleRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('retrievePartyRoleRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrievePartyRoleRiskAssessment: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
