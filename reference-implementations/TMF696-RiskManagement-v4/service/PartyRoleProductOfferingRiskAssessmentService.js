...
exports.createPartyRoleProductOfferingRiskAssessment = function(req, res, next) {
  /**
   * Creates a PartyRoleProductOfferingRiskAssessment
   * This operation creates a PartyRoleProductOfferingRiskAssessment entity.
   *
   * partyRoleProductOfferingRiskAssessment PartyRoleProductOfferingRiskAssessment_Create The PartyRoleProductOfferingRiskAssessment to be created
   * returns PartyRoleProductOfferingRiskAssessment
   **/

  console.log('createPartyRoleProductOfferingRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument partyRoleProductOfferingRiskAssessment */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createPartyRoleProductOfferingRiskAssessment', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createPartyRoleProductOfferingRiskAssessment', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createPartyRoleProductOfferingRiskAssessment: error=" + error);
    ...
    .catch( error => {
      console.log("createPartyRoleProductOfferingRiskAssessment: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deletePartyRoleProductOfferingRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('deletePartyRoleProductOfferingRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listPartyRoleProductOfferingRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('listPartyRoleProductOfferingRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listPartyRoleProductOfferingRiskAssessment: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrievePartyRoleProductOfferingRiskAssessment = function(req, res, next) {
  /**
  ...
  console.log('retrievePartyRoleProductOfferingRiskAssessment :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrievePartyRoleProductOfferingRiskAssessment: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
