...
exports.createEntitySpecification = function(req, res, next) {
  /**
   * Creates a EntitySpecification
   * This operation creates a EntitySpecification entity.
   *
   * entitySpecification EntitySpecification_Create The EntitySpecification to be created
   * returns EntitySpecification
   **/

  console.log('createEntitySpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument entitySpecification */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createEntitySpecification', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createEntitySpecification', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createEntitySpecification: error=" + error);
    ...
    .catch( error => {
      console.log("createEntitySpecification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteEntitySpecification = function(req, res, next) {
  /**
  ...
  console.log('deleteEntitySpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listEntitySpecification = function(req, res, next) {
  /**
  ...
  console.log('listEntitySpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listEntitySpecification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchEntitySpecification = function(req, res, next) {
  /**
   * Updates partially a EntitySpecification
   * This operation updates partially a EntitySpecification entity.
   *
   * id String Identifier of the EntitySpecification
   * entitySpecification EntitySpecification_Update The EntitySpecification to be updated
   * returns EntitySpecification
   **/

  console.log('patchEntitySpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchEntitySpecification',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchEntitySpecification error=" + error);
...
exports.retrieveEntitySpecification = function(req, res, next) {
  /**
  ...
  console.log('retrieveEntitySpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveEntitySpecification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
