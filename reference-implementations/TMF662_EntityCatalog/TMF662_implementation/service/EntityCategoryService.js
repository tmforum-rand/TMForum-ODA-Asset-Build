...
exports.createEntityCategory = function(req, res, next) {
  /**
   * Creates a EntityCategory
   * This operation creates a EntityCategory entity.
   *
   * entityCategory EntityCategory_Create The EntityCategory to be created
   * returns EntityCategory
   **/

  console.log('createEntityCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument entityCategory */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createEntityCategory', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createEntityCategory', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createEntityCategory: error=" + error);
    ...
    .catch( error => {
      console.log("createEntityCategory: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteEntityCategory = function(req, res, next) {
  /**
  ...
  console.log('deleteEntityCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listEntityCategory = function(req, res, next) {
  /**
  ...
  console.log('listEntityCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listEntityCategory: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchEntityCategory = function(req, res, next) {
  /**
   * Updates partially a EntityCategory
   * This operation updates partially a EntityCategory entity.
   *
   * id String Identifier of the EntityCategory
   * entityCategory EntityCategory_Update The EntityCategory to be updated
   * returns EntityCategory
   **/

  console.log('patchEntityCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchEntityCategory',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchEntityCategory error=" + error);
...
exports.retrieveEntityCategory = function(req, res, next) {
  /**
  ...
  console.log('retrieveEntityCategory :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveEntityCategory: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
