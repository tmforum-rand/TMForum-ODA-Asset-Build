...
exports.createNonFunctionalTestResult = function(req, res, next) {
  /**
   * Creates a NonFunctionalTestResult
   * This operation creates a NonFunctionalTestResult entity.
   *
   * nonFunctionalTestResult NonFunctionalTestResult_Create The NonFunctionalTestResult to be created
   * returns NonFunctionalTestResult
   **/

  console.log('createNonFunctionalTestResult :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument nonFunctionalTestResult */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createNonFunctionalTestResult', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createNonFunctionalTestResult', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createNonFunctionalTestResult: error=" + error);
    ...
    .catch( error => {
      console.log("createNonFunctionalTestResult: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteNonFunctionalTestResult = function(req, res, next) {
  /**
  ...
  console.log('deleteNonFunctionalTestResult :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listNonFunctionalTestResult = function(req, res, next) {
  /**
  ...
  console.log('listNonFunctionalTestResult :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listNonFunctionalTestResult: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchNonFunctionalTestResult = function(req, res, next) {
  /**
   * Updates partially a NonFunctionalTestResult
   * This operation updates partially a NonFunctionalTestResult entity.
   *
   * id String Identifier of the NonFunctionalTestResult
   * nonFunctionalTestResult NonFunctionalTestResult_Update The NonFunctionalTestResult to be updated
   * returns NonFunctionalTestResult
   **/

  console.log('patchNonFunctionalTestResult :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchNonFunctionalTestResult',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchNonFunctionalTestResult error=" + error);
...
exports.retrieveNonFunctionalTestResult = function(req, res, next) {
  /**
  ...
  console.log('retrieveNonFunctionalTestResult :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveNonFunctionalTestResult: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
