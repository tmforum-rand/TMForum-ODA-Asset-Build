...
exports.createPartyInteraction = function(req, res, next) {
  /**
   * Creates a PartyInteraction
   * This operation creates a PartyInteraction entity.
   *
   * partyInteraction PartyInteraction_Create The PartyInteraction to be created
   * returns PartyInteraction
   **/

  console.log('createPartyInteraction :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument partyInteraction */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createPartyInteraction', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createPartyInteraction', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createPartyInteraction: error=" + error);
    ...
    .catch( error => {
      console.log("createPartyInteraction: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deletePartyInteraction = function(req, res, next) {
  /**
  ...
  console.log('deletePartyInteraction :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listPartyInteraction = function(req, res, next) {
  /**
  ...
  console.log('listPartyInteraction :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listPartyInteraction: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchPartyInteraction = function(req, res, next) {
  /**
   * Updates partially a PartyInteraction
   * This operation updates partially a PartyInteraction entity.
   *
   * id String Identifier of the PartyInteraction
   * partyInteraction PartyInteraction_Update The PartyInteraction to be updated
   * returns PartyInteraction
   **/

  console.log('patchPartyInteraction :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchPartyInteraction',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchPartyInteraction error=" + error);
...
exports.retrievePartyInteraction = function(req, res, next) {
  /**
  ...
  console.log('retrievePartyInteraction :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrievePartyInteraction: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
