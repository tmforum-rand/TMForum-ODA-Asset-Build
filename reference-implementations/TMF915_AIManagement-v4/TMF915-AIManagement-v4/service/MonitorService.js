...
exports.listMonitor = function(req, res, next) {
  ...
  console.log('listMonitor :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listMonitor: error=" + error);
...
exports.retrieveMonitor = function(req, res, next) {
  ...
  console.log('retrieveMonitor :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveMonitor: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
