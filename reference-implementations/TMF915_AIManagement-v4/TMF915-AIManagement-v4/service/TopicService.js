...
exports.createTopic = function(req, res, next) {
   ...
   *
   * topic Topic_Create The Topic to be created
   * returns Topic
   **/

  console.log('createTopic :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument topic */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => processAssignmentRules('createTopic', payload))
    .then(payload => {
    ...
    .catch( error => {
      console.log("createTopic: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteTopic = function(req, res, next) {
  ...
  console.log('deleteTopic :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listTopic = function(req, res, next) {
  ...
  console.log('listTopic :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listTopic: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveTopic = function(req, res, next) {
  ...
  console.log('retrieveTopic :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveTopic: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
