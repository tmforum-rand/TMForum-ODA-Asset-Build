...
exports.createAiContractSpecification = function(req, res, next) {
  /**
   * Creates a AiContractSpecification
   * This operation creates a AiContractSpecification entity.
   *
   * aiContractSpecification AiContractSpecification_Create The AiContractSpecification to be created
   * returns AiContractSpecification
   **/

  console.log('createAiContractSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument aiContractSpecification */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createAiContractSpecification', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createAiContractSpecification', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createAiContractSpecification: error=" + error);
    ...
    .catch( error => {
      console.log("createAiContractSpecification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteAiContractSpecification = function(req, res, next) {
  /**
  ...
  console.log('deleteAiContractSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listAiContractSpecification = function(req, res, next) {
  /**
  ...
  console.log('listAiContractSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listAiContractSpecification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchAiContractSpecification = function(req, res, next) {
  /**
   * Updates partially a AiContractSpecification
   * This operation updates partially a AiContractSpecification entity.
   *
   * id String Identifier of the AiContractSpecification
   * aiContractSpecification AiContractSpecification_Update The AiContractSpecification to be updated
   * returns AiContractSpecification
   **/

  console.log('patchAiContractSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchAiContractSpecification',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchAiContractSpecification error=" + error);
...
exports.retrieveAiContractSpecification = function(req, res, next) {
  /**
  ...
  console.log('retrieveAiContractSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveAiContractSpecification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
