...
exports.createAiContractViolation = function(req, res, next) {
  /**
   * Creates a AiContractViolation
   * This operation creates a AiContractViolation entity.
   *
   * aiContractViolation AiContractViolation_Create The AiContractViolation to be created
   * returns AiContractViolation
   **/

  console.log('createAiContractViolation :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument aiContractViolation */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createAiContractViolation', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createAiContractViolation', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createAiContractViolation: error=" + error);
    ...
    .catch( error => {
      console.log("createAiContractViolation: error=" + error.toString());
      sendError(res, error);
    });
...
exports.listAiContractViolation = function(req, res, next) {
  /**
  ...
  console.log('listAiContractViolation :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listAiContractViolation: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveAiContractViolation = function(req, res, next) {
  /**
  ...
  console.log('retrieveAiContractViolation :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveAiContractViolation: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
