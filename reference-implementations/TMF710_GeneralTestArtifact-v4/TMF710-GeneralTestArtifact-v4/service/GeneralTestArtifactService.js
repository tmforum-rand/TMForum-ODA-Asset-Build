...
exports.createGeneralTestArtifact = function(req, res, next) {
  /**
   * Creates a GeneralTestArtifact
   * This operation creates a GeneralTestArtifact entity.
   *
   * generalTestArtifact GeneralTestArtifact_Create The GeneralTestArtifact to be created
   * returns GeneralTestArtifact
   **/

  console.log('createGeneralTestArtifact :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument generalTestArtifact */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createGeneralTestArtifact', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createGeneralTestArtifact', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createGeneralTestArtifact: error=" + error);
    ...
    .catch( error => {
      console.log("createGeneralTestArtifact: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteGeneralTestArtifact = function(req, res, next) {
  /**
  ...
  console.log('deleteGeneralTestArtifact :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listGeneralTestArtifact = function(req, res, next) {
  /**
  ...
  console.log('listGeneralTestArtifact :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listGeneralTestArtifact: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchGeneralTestArtifact = function(req, res, next) {
  /**
   * Updates partially a GeneralTestArtifact
   * This operation updates partially a GeneralTestArtifact entity.
   *
   * id String Identifier of the GeneralTestArtifact
   * generalTestArtifact GeneralTestArtifact_Update The GeneralTestArtifact to be updated
   * returns GeneralTestArtifact
   **/

  console.log('patchGeneralTestArtifact :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchGeneralTestArtifact',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchGeneralTestArtifact error=" + error);
...
exports.retrieveGeneralTestArtifact = function(req, res, next) {
  /**
  ...
  console.log('retrieveGeneralTestArtifact :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveGeneralTestArtifact: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
