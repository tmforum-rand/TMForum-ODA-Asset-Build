...
exports.createFinancialAccount = function(req, res, next) {
  /**
   * Creates a FinancialAccount
   * This operation creates a FinancialAccount entity.
   *
   * financialAccount FinancialAccount_Create The FinancialAccount to be created
   * returns FinancialAccount
   **/

  console.log('createFinancialAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument financialAccount */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createFinancialAccount', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createFinancialAccount', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createFinancialAccount: error=" + error);
    ...
    .catch( error => {
      console.log("createFinancialAccount: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteFinancialAccount = function(req, res, next) {
  /**
  ...
  console.log('deleteFinancialAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listFinancialAccount = function(req, res, next) {
  /**
  ...
  console.log('listFinancialAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listFinancialAccount: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchFinancialAccount = function(req, res, next) {
  /**
   * Updates partially a FinancialAccount
   * This operation updates partially a FinancialAccount entity.
   *
   * id String Identifier of the FinancialAccount
   * financialAccount FinancialAccount_Update The FinancialAccount to be updated
   * returns FinancialAccount
   **/

  console.log('patchFinancialAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchFinancialAccount',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchFinancialAccount error=" + error);
...
exports.retrieveFinancialAccount = function(req, res, next) {
  /**
  ...
  console.log('retrieveFinancialAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveFinancialAccount: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
