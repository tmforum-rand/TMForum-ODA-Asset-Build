...
exports.createBillFormat = function(req, res, next) {
  /**
   * Creates a BillFormat
   * This operation creates a BillFormat entity.
   *
   * billFormat BillFormat_Create The BillFormat to be created
   * returns BillFormat
   **/

  console.log('createBillFormat :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument billFormat */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createBillFormat', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createBillFormat', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createBillFormat: error=" + error);
    ...
    .catch( error => {
      console.log("createBillFormat: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteBillFormat = function(req, res, next) {
  /**
  ...
  console.log('deleteBillFormat :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listBillFormat = function(req, res, next) {
  /**
  ...
  console.log('listBillFormat :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listBillFormat: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchBillFormat = function(req, res, next) {
  /**
   * Updates partially a BillFormat
   * This operation updates partially a BillFormat entity.
   *
   * id String Identifier of the BillFormat
   * billFormat BillFormat_Update The BillFormat to be updated
   * returns BillFormat
   **/

  console.log('patchBillFormat :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchBillFormat',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchBillFormat error=" + error);
...
exports.retrieveBillFormat = function(req, res, next) {
  /**
  ...
  console.log('retrieveBillFormat :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveBillFormat: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
