...
exports.createBillingAccount = function(req, res, next) {
  /**
   * Creates a BillingAccount
   * This operation creates a BillingAccount entity.
   *
   * billingAccount BillingAccount_Create The BillingAccount to be created
   * returns BillingAccount
   **/

  console.log('createBillingAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument billingAccount */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createBillingAccount', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createBillingAccount', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createBillingAccount: error=" + error);
    ...
    .catch( error => {
      console.log("createBillingAccount: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteBillingAccount = function(req, res, next) {
  /**
  ...
  console.log('deleteBillingAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listBillingAccount = function(req, res, next) {
  /**
  ...
  console.log('listBillingAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listBillingAccount: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchBillingAccount = function(req, res, next) {
  /**
   * Updates partially a BillingAccount
   * This operation updates partially a BillingAccount entity.
   *
   * id String Identifier of the BillingAccount
   * billingAccount BillingAccount_Update The BillingAccount to be updated
   * returns BillingAccount
   **/

  console.log('patchBillingAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchBillingAccount',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchBillingAccount error=" + error);
...
exports.retrieveBillingAccount = function(req, res, next) {
  /**
  ...
  console.log('retrieveBillingAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveBillingAccount: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
