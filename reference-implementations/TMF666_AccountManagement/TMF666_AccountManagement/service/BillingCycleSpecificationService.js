...
exports.createBillingCycleSpecification = function(req, res, next) {
  /**
   * Creates a BillingCycleSpecification
   * This operation creates a BillingCycleSpecification entity.
   *
   * billingCycleSpecification BillingCycleSpecification_Create The BillingCycleSpecification to be created
   * returns BillingCycleSpecification
   **/

  console.log('createBillingCycleSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument billingCycleSpecification */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createBillingCycleSpecification', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createBillingCycleSpecification', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createBillingCycleSpecification: error=" + error);
    ...
    .catch( error => {
      console.log("createBillingCycleSpecification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteBillingCycleSpecification = function(req, res, next) {
  /**
  ...
  console.log('deleteBillingCycleSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listBillingCycleSpecification = function(req, res, next) {
  /**
  ...
  console.log('listBillingCycleSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listBillingCycleSpecification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchBillingCycleSpecification = function(req, res, next) {
  /**
   * Updates partially a BillingCycleSpecification
   * This operation updates partially a BillingCycleSpecification entity.
   *
   * id String Identifier of the BillingCycleSpecification
   * billingCycleSpecification BillingCycleSpecification_Update The BillingCycleSpecification to be updated
   * returns BillingCycleSpecification
   **/

  console.log('patchBillingCycleSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchBillingCycleSpecification',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchBillingCycleSpecification error=" + error);
...
exports.retrieveBillingCycleSpecification = function(req, res, next) {
  /**
  ...
  console.log('retrieveBillingCycleSpecification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveBillingCycleSpecification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
