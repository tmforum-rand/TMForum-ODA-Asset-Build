...
exports.createBillPresentationMedia = function(req, res, next) {
  /**
   * Creates a BillPresentationMedia
   * This operation creates a BillPresentationMedia entity.
   *
   * billPresentationMedia BillPresentationMedia_Create The BillPresentationMedia to be created
   * returns BillPresentationMedia
   **/

  console.log('createBillPresentationMedia :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument billPresentationMedia */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createBillPresentationMedia', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createBillPresentationMedia', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createBillPresentationMedia: error=" + error);
    ...
    .catch( error => {
      console.log("createBillPresentationMedia: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteBillPresentationMedia = function(req, res, next) {
  /**
  ...
  console.log('deleteBillPresentationMedia :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listBillPresentationMedia = function(req, res, next) {
  /**
  ...
  console.log('listBillPresentationMedia :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listBillPresentationMedia: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchBillPresentationMedia = function(req, res, next) {
  /**
   * Updates partially a BillPresentationMedia
   * This operation updates partially a BillPresentationMedia entity.
   *
   * id String Identifier of the BillPresentationMedia
   * billPresentationMedia BillPresentationMedia_Update The BillPresentationMedia to be updated
   * returns BillPresentationMedia
   **/

  console.log('patchBillPresentationMedia :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchBillPresentationMedia',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchBillPresentationMedia error=" + error);
...
exports.retrieveBillPresentationMedia = function(req, res, next) {
  /**
  ...
  console.log('retrieveBillPresentationMedia :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveBillPresentationMedia: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
