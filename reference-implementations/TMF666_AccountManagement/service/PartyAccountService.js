...
exports.createPartyAccount = function(req, res, next) {
  /**
   * Creates a PartyAccount
   * This operation creates a PartyAccount entity.
   *
   * partyAccount PartyAccount_Create The PartyAccount to be created
   * returns PartyAccount
   **/

  console.log('createPartyAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument partyAccount */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createPartyAccount', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createPartyAccount', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createPartyAccount: error=" + error);
    ...
    .catch( error => {
      console.log("createPartyAccount: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deletePartyAccount = function(req, res, next) {
  /**
  ...
  console.log('deletePartyAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listPartyAccount = function(req, res, next) {
  /**
  ...
  console.log('listPartyAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listPartyAccount: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchPartyAccount = function(req, res, next) {
  /**
   * Updates partially a PartyAccount
   * This operation updates partially a PartyAccount entity.
   *
   * id String Identifier of the PartyAccount
   * partyAccount PartyAccount_Update The PartyAccount to be updated
   * returns PartyAccount
   **/

  console.log('patchPartyAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchPartyAccount',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchPartyAccount error=" + error);
...
exports.retrievePartyAccount = function(req, res, next) {
  /**
  ...
  console.log('retrievePartyAccount :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrievePartyAccount: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
