...
exports.createSearchTimeSlot = function(req, res, next) {
  /**
   * Creates a SearchTimeSlot
   * This operation creates a SearchTimeSlot entity.
   *
   * searchTimeSlot SearchTimeSlot_Create The SearchTimeSlot to be created
   * returns SearchTimeSlot
   **/

  console.log('createSearchTimeSlot :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument searchTimeSlot */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createSearchTimeSlot', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createSearchTimeSlot', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createSearchTimeSlot: error=" + error);
    ...
    .catch( error => {
      console.log("createSearchTimeSlot: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteSearchTimeSlot = function(req, res, next) {
  /**
  ...
  console.log('deleteSearchTimeSlot :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listSearchTimeSlot = function(req, res, next) {
  /**
  ...
  console.log('listSearchTimeSlot :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listSearchTimeSlot: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchSearchTimeSlot = function(req, res, next) {
  /**
   * Updates partially a SearchTimeSlot
   * This operation updates partially a SearchTimeSlot entity.
   *
   * id String Identifier of the SearchTimeSlot
   * searchTimeSlot SearchTimeSlot_Update The SearchTimeSlot to be updated
   * returns SearchTimeSlot
   **/

  console.log('patchSearchTimeSlot :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchSearchTimeSlot',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchSearchTimeSlot error=" + error);
...
exports.retrieveSearchTimeSlot = function(req, res, next) {
  /**
  ...
  console.log('retrieveSearchTimeSlot :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveSearchTimeSlot: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
