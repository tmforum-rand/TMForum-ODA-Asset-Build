...
exports.createCancelResourceOrder = function(req, res, next) {
   ...
   *
   * cancelResourceOrder CancelResourceOrder_Create The CancelResourceOrder to be created
   * returns CancelResourceOrder
   **/

  console.log('createCancelResourceOrder :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument cancelResourceOrder */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createCancelResourceOrder: error=" + error);
    ...
    .catch( error => {
      console.log("createCancelResourceOrder: error=" + error.toString());
      sendError(res, error);
    });
...
exports.listCancelResourceOrder = function(req, res, next) {
  ...
  console.log('listCancelResourceOrder :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listCancelResourceOrder: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveCancelResourceOrder = function(req, res, next) {
  ...
  console.log('retrieveCancelResourceOrder :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveCancelResourceOrder: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
