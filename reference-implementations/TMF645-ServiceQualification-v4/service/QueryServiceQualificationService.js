...
exports.createQueryServiceQualification = function(req, res, next) {
  /**
   * Creates a QueryServiceQualification
   * This operation creates a QueryServiceQualification entity.
   *
   * queryServiceQualification QueryServiceQualification_Create The QueryServiceQualification to be created
   * returns CheckServiceQualification
   **/

  console.log('createQueryServiceQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument queryServiceQualification */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createQueryServiceQualification', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createQueryServiceQualification', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createQueryServiceQualification: error=" + error);
    ...
    .catch( error => {
      console.log("createQueryServiceQualification: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteQueryServiceQualification = function(req, res, next) {
  /**
  ...
  console.log('deleteQueryServiceQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listQueryServiceQualification = function(req, res, next) {
  /**
  ...
  console.log('listQueryServiceQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listQueryServiceQualification: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchQueryServiceQualification = function(req, res, next) {
  /**
   * Updates partially a QueryServiceQualification
   * This operation updates partially a QueryServiceQualification entity.
   *
   * id String Identifier of the QueryServiceQualification
   * queryServiceQualification QueryServiceQualification_Update The QueryServiceQualification to be updated
   * returns QueryServiceQualification
   **/

  console.log('patchQueryServiceQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req,'patchQueryServiceQualification',payload))
    .then(payload => traverse(req,requestSchema,payload,[],getPayloadType(req)))
    .then(payload => {
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchQueryServiceQualification error=" + error);
...
exports.retrieveQueryServiceQualification = function(req, res, next) {
  /**
  ...
  console.log('retrieveQueryServiceQualification :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveQueryServiceQualification: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
