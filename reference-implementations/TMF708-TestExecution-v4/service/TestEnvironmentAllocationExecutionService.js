...
exports.createTestEnvironmentAllocationExecution = function(req, res, next) {
  /**
   * Creates a TestEnvironmentAllocationExecution
   * This operation creates a TestEnvironmentAllocationExecution entity.
   *
   * testEnvironmentAllocationExecution TestEnvironmentAllocationExecution_Create The TestEnvironmentAllocationExecution to be created
   * returns TestEnvironmentAllocationExecution
   **/

  console.log('createTestEnvironmentAllocationExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument testEnvironmentAllocationExecution */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createTestEnvironmentAllocationExecution', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createTestEnvironmentAllocationExecution', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createTestEnvironmentAllocationExecution: error=" + error);
    ...
    .catch( error => {
      console.log("createTestEnvironmentAllocationExecution: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteTestEnvironmentAllocationExecution = function(req, res, next) {
  /**
  ...
  console.log('deleteTestEnvironmentAllocationExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listTestEnvironmentAllocationExecution = function(req, res, next) {
  /**
  ...
  console.log('listTestEnvironmentAllocationExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listTestEnvironmentAllocationExecution: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveTestEnvironmentAllocationExecution = function(req, res, next) {
  /**
  ...
  console.log('retrieveTestEnvironmentAllocationExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveTestEnvironmentAllocationExecution: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
