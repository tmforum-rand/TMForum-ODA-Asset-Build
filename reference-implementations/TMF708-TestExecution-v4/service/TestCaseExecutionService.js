...
exports.createTestCaseExecution = function(req, res, next) {
  /**
   * Creates a TestCaseExecution
   * This operation creates a TestCaseExecution entity.
   *
   * testCaseExecution TestCaseExecution_Create The TestCaseExecution to be created
   * returns TestCaseExecution
   **/

  console.log('createTestCaseExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument testCaseExecution */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createTestCaseExecution', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createTestCaseExecution', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createTestCaseExecution: error=" + error);
    ...
    .catch( error => {
      console.log("createTestCaseExecution: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteTestCaseExecution = function(req, res, next) {
  /**
  ...
  console.log('deleteTestCaseExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listTestCaseExecution = function(req, res, next) {
  /**
  ...
  console.log('listTestCaseExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listTestCaseExecution: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveTestCaseExecution = function(req, res, next) {
  /**
  ...
  console.log('retrieveTestCaseExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveTestCaseExecution: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
