...
exports.createNonFunctionalTestExecution = function(req, res, next) {
  /**
   * Creates a NonFunctionalTestExecution
   * This operation creates a NonFunctionalTestExecution entity.
   *
   * nonFunctionalTestExecution NonFunctionalTestExecution_Create The NonFunctionalTestExecution to be created
   * returns NonFunctionalTestExecution
   **/

  console.log('createNonFunctionalTestExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument nonFunctionalTestExecution */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createNonFunctionalTestExecution', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createNonFunctionalTestExecution', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createNonFunctionalTestExecution: error=" + error);
    ...
    .catch( error => {
      console.log("createNonFunctionalTestExecution: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteNonFunctionalTestExecution = function(req, res, next) {
  /**
  ...
  console.log('deleteNonFunctionalTestExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listNonFunctionalTestExecution = function(req, res, next) {
  /**
  ...
  console.log('listNonFunctionalTestExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listNonFunctionalTestExecution: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveNonFunctionalTestExecution = function(req, res, next) {
  /**
  ...
  console.log('retrieveNonFunctionalTestExecution :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveNonFunctionalTestExecution: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
