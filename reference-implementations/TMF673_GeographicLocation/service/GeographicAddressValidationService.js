...
exports.createGeographicAddressValidation = function (req, res, next) {
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      //payload.validationResult = Math.random()  > 0.5 ? "success": "fails"
      payload.validationResult = req.headers["validation-result"] || "success"
      if (payload.validationResult === "fails" && payload.provideAlternative) {
        payload.alternateGeographicAddress = [{
          streetName: "alternative",
          streetType: "street",
          locality: "Brighton",
          postcode: "SA",
          country: "Australia"
