...
var DefaultURL = "https://api-partnership-v4-0-0.mybluemix.net/tmf-api/partnershipManagement/v4/";
var schema;
var hostname;
var port;
var APIRelativeAddress;
var statusCode;
const exampleEndPoint = "partnershipSpecification";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF668 Partnership\n");
getURL();
...
function runNewman(){
    ...
    newman.run({
        collection: require('./668-Partnership.postman_collection.json'),
